...
linearMod <- glm(win ~ rpi_difference, data=rpi_regression2, family=binomial(link="logit"))  # build linear regression model on full data
print(linearMod)
...
#linear regression model
linearMod <- glm(win ~ rpi_difference_square+rpi_difference, data=rpi_regression3,family=binomial(link="logit"))  # build linear regression model on full data
print(linearMod)
